<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="DataBinding.aspx.cs"
    Inherits="Gantt_DataBinding" Title="Data Binding (ASP.NET Gantt) | DayPilot Pro for ASP.NET WebForms Demo" %>

<%@ Register Assembly="DayPilot" Namespace="DayPilot.Web.Ui" TagPrefix="DayPilot" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    
    <div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/gantt/task-loading/">Gantt task loading</a>.</div>
    ...
    <DayPilot:DayPilotGantt
        ...
        <Columns>
            ...
            <DayPilot:TaskColumn Title="Id" Property="id" Width="100" />
        </Columns>
    </DayPilot:DayPilotGantt>
