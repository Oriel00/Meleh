...
public partial class Scheduler_ProgressiveEventRendering : System.Web.UI.Page
{
    ...
    protected void DayPilotScheduler1_EventAdd(object sender, EventAddEventArgs e)
    {
        ...
        DataRow dr = table.NewRow();
        dr["start"] = e.Event.Start;
        dr["end"] = e.Event.End;
        dr["column"] = e.Event.Resource;
        dr["name"] = e.Event.Text;
        dr["id"] = e.Event.Value;
        table.Rows.Add(dr);
        table.AcceptChanges();
    ...
    protected void ButtonExport_Click(object sender, EventArgs e)
    {
        ...
        DayPilotScheduler1.CellWidth = 600;
