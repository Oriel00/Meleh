<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventSelecting.aspx.cs"
    Inherits="Scheduler_EventSelecting" Title="Event Selecting (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-nz" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        <b>Note:</b> Use Ctrl + click to select multiple events.
        Read more about <a href="http://doc.daypilot.org/scheduler/event-selecting/">event selecting</a> [doc.daypilot.org].
    </div>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        xEventSelectHandling="JavaScript"
        xEventSelectJavaScript="dps1.multiselect.add(dps1.events.find('1')); dps1.multiselect.redraw();"
        ...
        EventRightClickJavaScript="alert('isSelected: ' + dps1.multiselect.isSelected(e));"
        >
        <Resources>
    ...
    <br />
    <a href="#" onclick="alert('Number of selected events: ' + dps1.multiselect.events().length); return false; ">Count</a><br />
    <a href="#" onclick="dps1.multiselect.clear(); return false; ">Clear</a><br />
    <a href="#" onclick="dps1.commandCallBack('selected'); return false;">Test server</a><br />
