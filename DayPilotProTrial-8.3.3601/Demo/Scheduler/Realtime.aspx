<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="Realtime.aspx.cs"
    Inherits="Scheduler_Realtime" Title="Real-Time Position Indicators (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
	...
	<div class="note"><b>Note:</b> Drag and drop operations (event creating, moving, and resizing) display current position details.</div>
