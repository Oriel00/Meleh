<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="AutoCellWidth.aspx.cs"
    Inherits="Scheduler_AutoCellWidth" Title="Auto Cell Width (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
<script type="text/javascript">
    ...
    <div class="note">
        <b>Note:</b> Read more about <a href="http://doc.daypilot.org/scheduler/auto-cell-width/">auto cell width</a> [doc.daypilot.org].
    </div>
