<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecurrentEventEdit.aspx.cs" Inherits="Scheduler_RecurrentEventEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Recurrent Event Edit</title>
    <style type="text/css">
...
<body>
    ...
    <div>
        ...
        <tr>
            <td>Start:</td>
            <td><asp:TextBox ID="TextBoxStart" runat="server" Width="400px"></asp:TextBox></td>
        </tr>
        <tr>
            <td>End:</td>
            <td><asp:TextBox ID="TextBoxEnd" runat="server" Width="400px"></asp:TextBox></td>
        </tr>
        </table>
...
<!-- Recurrence section -->
<script type="text/javascript" src="../js/recurrence.js"></script>
        Repeat:
        <select id="repeat">
...
<!-- Recurrence section ends here -->
    ...
    <div style="margin-top:10px;">
        ...
        <asp:Button ID="ButtonCancel" runat="server" OnClick="ButtonCancel_Click" Text="Cancel" /></div>
    </div>
    </form>
</body>
</html>
