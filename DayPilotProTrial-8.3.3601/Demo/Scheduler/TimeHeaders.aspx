<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="TimeHeaders.aspx.cs"
    Inherits="Scheduler_TimeHeaders" Title="Time Headers (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        <b>Note:</b> Read more customizing the <a href="http://doc.daypilot.org/scheduler/time-header-rows/">time header rows</a> [doc.daypilot.org].
    </div>
