<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="LimitEventMoving.aspx.cs"
    Inherits="Scheduler_Default" Title="Limit Event Moving (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        ...
        Read more about <a href="http://doc.daypilot.org/scheduler/limit-event-moving/">event moving restrictions</a> [doc.daypilot.org].
    </div>
