<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventOverlapping.aspx.cs"
    Inherits="Scheduler_EventOverlapping" Title="Event Overlapping (AJAX Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
	...
	<div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/scheduler/event-overlapping/">preventing event overlaps</a>.</div>
