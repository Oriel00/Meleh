<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="RowAll.aspx.cs"
    Inherits="Scheduler_RowAll" Title="Row Editing (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
	...
	<div class="note"><b>Note:</b> Select a row by clicking on a row header.</div>
