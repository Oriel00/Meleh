...
public partial class Scheduler_DragDropTwoSchedulers : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DayPilotScheduler2.StartDate = new DateTime(DateTime.Today.Year, 1, 1);
        DayPilotScheduler2.Days = Year.Days(DateTime.Today.Year);
        DayPilotScheduler2.Separators.Add(DateTime.Today, Color.Red);
    ...
    private void setDataSourceAndBind()
    {
        ...
        DayPilotScheduler2.DataSource = getData(DayPilotScheduler2.StartDate, DayPilotScheduler2.EndDate, (string)DayPilotScheduler2.ClientState["filter"]);
    ...
    protected void DayPilotScheduler2_EventMove(object sender, DayPilot.Web.Ui.Events.EventMoveEventArgs e)
    {
        ...
        //DayPilotScheduler1.ScrollX = 2900;
        DayPilotScheduler2.UpdateWithMessage("Event moved.");
    }
