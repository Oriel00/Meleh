...
public partial class Scheduler_Korean : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DayPilotScheduler1.DateTimeFormatInfo = new CultureInfo("ko-kr", false).DateTimeFormat;
        DayPilotScheduler1.DateTimeFormatInfo.Calendar = new KoreanCalendar();
