<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="Crosshair.aspx.cs"
    Inherits="Scheduler_Crosshair" Title="Crosshair (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        <b>Note:</b> Read more about the <a href="http://doc.daypilot.org/scheduler/crosshair/">crosshair</a> [doc.daypilot.org].
    </div>
