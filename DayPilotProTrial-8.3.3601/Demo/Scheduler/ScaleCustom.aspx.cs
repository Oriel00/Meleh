...
public partial class Scheduler_ScaleCustom : System.Web.UI.Page
{
    ...
    private void setDataSourceAndBind()
    {
        ...
        DayPilotScheduler1.DataSource = getData(DayPilotScheduler1.VisibleStart, DayPilotScheduler1.VisibleEnd, filter);
    ...
    protected void DayPilotScheduler1_Command(object sender, DayPilot.Web.Ui.Events.CommandEventArgs e)
    {
        switch (e.Command)
        {
            ...
            case "scale":
                DayPilotScheduler1.CellDuration = (int) e.Data["cellDuration"];
                DayPilotScheduler1.SetScrollX(DateTime.Today);
                break;
            default:
