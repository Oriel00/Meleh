<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventStackingLineHeight.aspx.cs"
    Inherits="Scheduler_EventStackingLineHeight" Title="Event Stacking Line Height (ASP.NET Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
	...
	<div class="note"><b>Note:</b> EventStackingLineHeight is set to 30. This means each line of concurrent events will take 30% of its height.</div>
