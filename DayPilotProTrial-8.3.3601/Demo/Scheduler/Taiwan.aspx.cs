...
public partial class Scheduler_Taiwan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DayPilotScheduler1.DateTimeFormatInfo = new CultureInfo("zh-tw", false).DateTimeFormat;
        DayPilotScheduler1.DateTimeFormatInfo.Calendar = new TaiwanCalendar();
