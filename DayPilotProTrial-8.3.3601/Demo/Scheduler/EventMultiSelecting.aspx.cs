...
public partial class Scheduler_EventMultiSelecting : System.Web.UI.Page
{
    ...
    protected void DropDownMode_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        switch (DropDownMode.SelectedValue)
        {
            case "Free":
                DayPilotScheduler1.MultiSelectRectangle = MultiSelectRectangleType.Free;
                break;
            case "Row":
                DayPilotScheduler1.MultiSelectRectangle = MultiSelectRectangleType.Row;
                break;
        }
        setDataSourceAndBind();
        DayPilotScheduler1.Update();
