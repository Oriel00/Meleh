...
public partial class Scheduler_RowAll : System.Web.UI.Page
{
    ...
    {
        e.Areas.Add(new Area().Width(17).Bottom(0).Right(0).Top(0).CssClass("resource_action_menu").Html("<div><div></div></div>").HoverMenu("cmRes"));
    }
