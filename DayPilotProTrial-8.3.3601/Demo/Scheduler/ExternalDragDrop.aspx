<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ExternalDragDrop.aspx.cs"
    Inherits="Scheduler_ExternalDragDrop" Title="External Drag &amp; Drop (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
    <b>Note:</b> Below the scheduler, there is a list of events that can be dragged into the Scheduler.
    Read more about <a href="http://doc.daypilot.org/scheduler/external-drag-and-drop/">external drag and drop</a> [doc.daypilot.org].
    </div>
