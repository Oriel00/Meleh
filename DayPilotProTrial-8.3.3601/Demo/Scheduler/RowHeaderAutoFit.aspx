<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="RowHeaderAutoFit.aspx.cs"
    Inherits="Scheduler_RowHeaderAutoFit" Title="Row Header Width Auto-Fit (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
    ...
    Read more about <a href="http://doc.daypilot.org/scheduler/row-header-width-auto-fit/">row header width auto-fit</a> [doc.daypilot.org].
    </div>
