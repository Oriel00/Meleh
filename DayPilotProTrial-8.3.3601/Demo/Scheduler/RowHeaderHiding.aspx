<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="RowHeaderHiding.aspx.cs"
    Inherits="Scheduler_RowHeaderHiding" Title="Row Header Hiding (AJAX Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
	...
	<div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/scheduler/row-header-hiding/">row header hiding</a>.</div>
