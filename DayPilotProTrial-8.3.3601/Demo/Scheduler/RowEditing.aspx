<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="RowEditing.aspx.cs"
    Inherits="Scheduler_RowEditing" Title="Row Editing (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
    ...
    <div class="note"><b>Note:</b> Click the row header to edit the text. Read more about <a href="http://doc.daypilot.org/scheduler/row-editing/">row editing</a> [doc.daypilot.org].</div>
