<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ScaleCustom.aspx.cs"
    Inherits="Scheduler_ScaleCustom" Title="Custom Scale (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
<div class="note"><b>Note:</b> Read more about the <a href="http://doc.daypilot.org/scheduler/timeline/">scheduler timeline</a> customization [doc.daypilot.org].</div>
