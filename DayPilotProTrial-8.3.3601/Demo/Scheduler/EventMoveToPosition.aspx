<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventMoveToPosition.aspx.cs"
    Inherits="Scheduler_EventMoveToPosition" Title="Move Event to Position (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<div class="note"><b>Note:</b> Read more about moving events to a <a href="http://doc.daypilot.org/scheduler/event-position/">specific position inside a cell</a> [doc.daypilot.org].</div>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        >
        <Resources>
            <DayPilot:Resource Name="Room A" Id="A" Expanded="False">
                <Children>
