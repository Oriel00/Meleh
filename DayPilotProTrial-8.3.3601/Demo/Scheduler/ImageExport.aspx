<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ImageExport.aspx.cs"
    Inherits="Scheduler_ImageExport" Title="Image Export (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        <b>Note:</b> Read more about the <a href="http://doc.daypilot.org/scheduler/image-export-png-jpg-gif-jpg/">image export</a> [doc.daypilot.org].
    </div>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        >
        <HeaderColumns>
            <DayPilot:RowHeaderColumn Title="Column 1" Width="80"></DayPilot:RowHeaderColumn>
            <DayPilot:RowHeaderColumn Title="Column 2" Width="80"></DayPilot:RowHeaderColumn>
        </HeaderColumns>
        <Resources>
