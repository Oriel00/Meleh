...
public partial class Scheduler_Hijri : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DayPilotScheduler1.DateTimeFormatInfo = new CultureInfo("ar-sa", false).DateTimeFormat;
        DayPilotScheduler1.DateTimeFormatInfo.Calendar = new HijriCalendar();
