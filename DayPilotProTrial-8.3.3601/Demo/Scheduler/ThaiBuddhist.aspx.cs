...
public partial class Scheduler_ThaiBuddhist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DayPilotScheduler1.DateTimeFormatInfo = new CultureInfo("th-th", false).DateTimeFormat;
        DayPilotScheduler1.DateTimeFormatInfo.Calendar = new ThaiBuddhistCalendar();
