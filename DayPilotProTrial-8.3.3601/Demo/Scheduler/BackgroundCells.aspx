<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="BackgroundCells.aspx.cs"
    Inherits="Scheduler_BackgroundCells" Title="Tree & Filter (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-nz" %>
