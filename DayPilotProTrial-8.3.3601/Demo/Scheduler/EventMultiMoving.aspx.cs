...
public partial class Scheduler_EventMultiMoving : System.Web.UI.Page
{
    ...
    private void MoveEvent(string id, DateTime newStart, DateTime newEnd, string newResource)
    {
