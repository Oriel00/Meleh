<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventMultiSelecting.aspx.cs"
    Inherits="Scheduler_EventMultiSelecting" Title="Event Multi-Selecting (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-nz" %>
...
/* Event editing helpers - modal dialog */
    ...
    <style>
        #DayPilotScheduler1 .scheduler_default_selected .scheduler_default_event_inner {
    ...
    <div class="note">
        <b>Note:</b> Select multiple events using Shift + mouse drag. Use Ctrl + click to add/remove events from selection.
        Read more about <a href="http://doc.daypilot.org/scheduler/event-multi-selecting/">event multi-selecting</a> [doc.daypilot.org].
    </div>
    

    <div class="space">Select mode:
        <asp:DropDownList runat="server" ID="DropDownMode" AutoPostBack="true" OnSelectedIndexChanged="DropDownMode_OnSelectedIndexChanged">
    ...
    <div class="space">
        Clear selection: 
        <a href="javascript:dps.multiselect.clear();">Clear</a>
    </div>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        EventRightClickJavaScript="alert('isSelected: ' + dps.multiselect.isSelected(e));"
        >
        <Resources>
    ...
    <DayPilot:DayPilotMenu ID="DayPilotMenu2" runat="server" >
        ...
        <DayPilot:MenuItem Text="Refresh" Action="JavaScript" JavaScript="dps.commandCallBack('refresh');">
        </DayPilot:MenuItem>
    ...
    <DayPilot:DayPilotMenu ID="DayPilotMenuSpecial" runat="server" ClientObjectName="cmSpecial" 
        ...
        <DayPilot:MenuItem Text="Delete (JavaScript using callback)" Action="JavaScript"
            Command='Delete' JavaScript="if (confirm('Do you really want to delete event ' + e.text() + ' ?')) dps.eventMenuClickCallBack(e, command);">
        </DayPilot:MenuItem>
    </DayPilot:DayPilotMenu>
    
    <DayPilot:DayPilotMenu ID="DayPilotMenuSelection" runat="server"  >
        <DayPilot:MenuItem Action="JavaScript" JavaScript="dps.timeRangeSelectedCallBack(e.start, e.end, e.resource);"
        ...
        <DayPilot:MenuItem Action="JavaScript" JavaScript="dps.clearSelection();" Text="Clean selection" />
    </DayPilot:DayPilotMenu>
