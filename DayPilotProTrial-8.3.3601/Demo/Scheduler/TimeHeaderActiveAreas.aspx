<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="TimeHeaderActiveAreas.aspx.cs"
    Inherits="Scheduler_TimeHeaderActiveAreas" Title="Time Header Active Areas (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
	...
	<div class="note">
	    <b>Note:</b> You can specify active areas for the time header cells using BeforeTimeHeaderRender event handler.
    </div>
