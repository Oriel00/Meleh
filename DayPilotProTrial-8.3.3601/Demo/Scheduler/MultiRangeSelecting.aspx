<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="MultiRangeSelecting.aspx.cs"
    Inherits="Scheduler_MultiRangeSelecting" Title="Multi-Range Selecting (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-nz" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note"><b>Note:</b> You can select multiple time ranges while holding Ctrl. Read more about <a href="http://doc.daypilot.org/scheduler/time-range-multi-selecting/">time range multi-selecting</a>.</div>
