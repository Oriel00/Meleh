<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="PercentComplete.aspx.cs"
    Inherits="Scheduler_PercentComplete" Title="Percent Complete (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
	...
	<div class="note"><b>Note:</b> Read more about using the duration bar as a <a href="http://doc.daypilot.org/scheduler/percent-complete/">percent complete</a> indicator [doc.daypilot.org].</div>
