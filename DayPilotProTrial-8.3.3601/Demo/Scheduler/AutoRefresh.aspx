<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="AutoRefresh.aspx.cs"
    Inherits="Scheduler_AutoRefresh" Title="AutoRefresh (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        <b>Note:</b> The scheduler events are reloaded automatically from the server every 10 seconds (for 2 minutes).
        Read more about the <a href="http://doc.daypilot.org/scheduler/autorefresh/">AutoRefresh</a> [doc.daypilot.org].
    </div>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        xContextMenuSelectionID="DayPilotMenuSelection" 
