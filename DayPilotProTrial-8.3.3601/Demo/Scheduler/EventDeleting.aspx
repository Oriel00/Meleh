<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventDeleting.aspx.cs"
    Inherits="Scheduler_EventDeleting" Title="Event Deleting (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-nz" %>
<%@ Import Namespace="DayPilot.Web.Ui.Events.Scheduler" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
    <b>Note:</b> Read more about <a href="http://doc.daypilot.org/scheduler/event-deleting/">event deleting</a> [doc.daypilot.org].
    </div>
