...
public partial class Scheduler_RowMoving : System.Web.UI.Page
{
    ...
    protected void DayPilotScheduler1_BeforeResHeaderRender(object sender, DayPilot.Web.Ui.Events.Scheduler.BeforeResHeaderRenderEventArgs e)
    {
        ...
        {
            e.MoveEnabled = false;
            e.Html += " (moving disabled)";
        }
        e.Columns[0].Html = "test";
    ...
    protected void DayPilotScheduler1_OnResourceExpand(object sender, ResourceExpandEventArgs e)
    {
    }

    protected void DayPilotScheduler1_OnRowMove(object sender, RowMoveEventArgs e)
    {
        e.Move();
        setDataSourceAndBind();
        DayPilotScheduler1.Update();
