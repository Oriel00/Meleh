<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ProgressiveEventRenderingDelayed.aspx.cs"
    Inherits="Scheduler_ProgressiveEventRenderingDelayed" Title="Progressive Event Rendering, Delayed (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-nz" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
    <div>
    <b>Note:</b> This demo shows loads the event after client-side initialization using a special AJAX CallBack (ClientInit event). 
    </div>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        ClientInitEventEnabled="true"
        OnClientInit="DayPilotScheduler1_OnClientInit"
        >
        <Resources>
