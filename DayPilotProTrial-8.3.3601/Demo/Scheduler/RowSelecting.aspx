<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="RowSelecting.aspx.cs"
    Inherits="Scheduler_RowSelecting" Title="Row Selecting (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
	...
	<div class="note"><b>Note:</b> Select a row by clicking on a row header. Use Ctrl + click to select multiple rows. Read more about <a href="http://doc.daypilot.org/scheduler/row-selecting/">row selecting</a> [doc.daypilot.org].</div>
