<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventMultiMoving.aspx.cs"
    Inherits="Scheduler_EventMultiMoving" Title="Event Multi-Moving (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-nz" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note"><b>Note:</b> You can select multiple events (use Ctrl+click) and move all of them in time at once. Read more about <a href="http://doc.daypilot.org/scheduler/event-multi-moving/">event multimoving</a> [doc.daypilot.org].</div>
