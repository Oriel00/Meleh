<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ActiveAreas.aspx.cs"
    Inherits="Scheduler_ActiveAreas" Title="Active Areas (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  %>
...
/* Event editing helpers - modal dialog */
	...
	<div class="note">
	    <b>Note:</b> Hold a cursor on an event or a resource header to see the active areas.
        Read more about <a href="http://doc.daypilot.org/scheduler/event-active-areas/">event active areas</a> [doc.daypilot.org].
    </div>
    ...
    <DayPilot:DayPilotMenu ID="DayPilotMenuRes" runat="server" ClientObjectName="cmRes" HideOnMouseOut="true" >
