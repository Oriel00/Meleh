<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventLinks.aspx.cs"
    Inherits="Scheduler_EventLinks" Title="Event Links (ASP.NET Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
	...
	<div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/scheduler/event-links/">event links</a>.</div>
