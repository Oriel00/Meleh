<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="RowMoving.aspx.cs"
    Inherits="Scheduler_RowMoving" Title="Row Moving (Scheduler) | DayPilot Pro for ASP.NET WebForms Demo"  Culture="en-us" %>
...
<script type="text/javascript">
    ...
    <div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/scheduler/row-moving/">row moving</a> [doc.daypilot.org].</div>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        RowMoveHandling="CallBack"
        OnRowMove="DayPilotScheduler1_OnRowMove"
        >
        <HeaderColumns>
            <DayPilot:RowHeaderColumn Title="First" Width="80"></DayPilot:RowHeaderColumn>
            <DayPilot:RowHeaderColumn Title="Second" Width="80"></DayPilot:RowHeaderColumn>
        </HeaderColumns>
        <Resources>
