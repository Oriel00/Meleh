<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="Crosshair.aspx.cs"
Inherits="Calendar_Crosshair" Title="Crosshair (Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        <b>Note:</b> Two Crosshair modes are supported: Header (headers only) and Full (full crosshair).
        Read more about <a href="http://doc.daypilot.org/calendar/crosshair/">crosshair</a> [doc.daypilot.org].
    </div>
