<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="TimeHeaderCellDuration.aspx.cs"
Inherits="Calendar_TimeHeaderCellDuration" Title="Time Header Cell Duration (Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note">
        <b>Note:</b> Use TimeHeaderCellDuration property to set the size of the calendar time header cells. The default value is 60 [minutes]. This example uses 30 to match the headers with the cells (CellDuration="30").
        Read more about <a href="http://doc.daypilot.org/calendar/time-header-cell-duration/">time header cell duration</a> [doc.daypilot.org].
    </div>
