...
CodeFile="HeaderDateFormat.aspx.cs" Inherits="HeaderDateFormat" Title="Header Date Format (Calendar) | DayPilot Pro for ASP.NET WebForms Demo" Culture="en-US" %>

<%@ Register Assembly="DayPilot" Namespace="DayPilot.Web.Ui" TagPrefix="DayPilot" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
    <div class="note">
        <b>Note:</b> Read more about the <a href="http://doc.daypilot.org/calendar/header-date-format/">header date format</a> [doc.daypilot.org].
    </div>
