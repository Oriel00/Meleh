...
Inherits="Calendar_Notify" Title="Notify Event Model (Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note"><b>Note:</b> EventMoveHandling and EventResizeHandling properties are set to "Notify". This applies changes on the client side (without requesting a new event set from the server) and then fires the event handler. Read more about the <a href="http://doc.daypilot.org/scheduler/notify-event-model/">Notify event model</a> [doc.daypilot.org].</div>
