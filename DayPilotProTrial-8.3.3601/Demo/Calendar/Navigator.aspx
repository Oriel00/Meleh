<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="Navigator.aspx.cs"
Inherits="Calendar_Navigator" Title="Navigator (AJAX Event Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/calendar/navigator/">date navigator integration</a> [doc.daypilot.org].</div>
