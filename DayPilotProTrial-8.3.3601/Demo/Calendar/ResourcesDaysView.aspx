<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ResourcesDaysView.aspx.cs"
    Inherits="ResourcesDaysView" Title="Resources-Days View (Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
