<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="HighlightingToday.aspx.cs"
Inherits="Calendar_HighlightingToday" Title="Hightlighting Today (Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
var copied = null;
    ...
    <div class="note">
        <b>Note:</b> Read more about <a href="http://doc.daypilot.org/calendar/highlighting-today/">highlighting today</a> in the calendar [doc.daypilot.org].
    </div>
