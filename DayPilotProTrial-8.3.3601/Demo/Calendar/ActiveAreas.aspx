...
Inherits="Calendar_ActiveAreas" Title="Active Areas (Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
/* Event editing helpers - modal dialog */
    ...
    <div class="note"><b>Note:</b> Hold a cursor on an event or a column header to see the active areas. Read more about <a href="http://doc.daypilot.org/calendar/event-active-areas/">event active areas</a> [doc.daypilot.org].</div>
    ...
    <DayPilot:DayPilotBubble 
        ...
        Position="EventTop"
        OnRenderCellBubble="DayPilotBubble1_OnRenderCellBubble"
        HideAfter="0"
        >
    </DayPilot:DayPilotBubble>
