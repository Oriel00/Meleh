<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ActiveAreas.aspx.cs"
    Inherits="Month_ActiveAreas" Title="Active Areas (Monthly Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="note">
        <b>Note:</b> Hold a cursor on an event to see the active areas.
        Read more about <a href="http://doc.daypilot.org/month/event-active-areas/">event active areas</a> [doc.daypilot.org].
    </div>
