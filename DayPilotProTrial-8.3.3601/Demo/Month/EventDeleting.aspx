<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EventDeleting.aspx.cs"
    Inherits="Month_EventDeleting" Title="Event Deleting (Month View) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="note">
        <b>Note:</b> Read more about <a href="http://doc.daypilot.org/month/event-deleting/">event deleting</a> [doc.daypilot.org].
    </div>
