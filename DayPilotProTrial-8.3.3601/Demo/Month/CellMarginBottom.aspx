<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="CellMarginBottom.aspx.cs"
    Inherits="Month_CellMarginBottom" Title="Bottom Cell Margin (AJAX Monthly Calendar) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/month/event-spacing/">event spacing</a> [doc.daypilot.org].</div>
