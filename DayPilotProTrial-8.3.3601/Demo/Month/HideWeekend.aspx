<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="HideWeekend.aspx.cs"
    Inherits="Month_HideWeekend" Title="Hide Weekend (Month) | DayPilot Pro for ASP.NET WebForms Demo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="note"><b>Note:</b> Read more about <a href="http://doc.daypilot.org/month/hiding-weekends/">hiding weekends</a> [doc.daypilot.org].</div>
    ...
    <DayPilot:DayPilotMonth ID="DayPilotMonth1" runat="server" 
        ...
        xOnBeforeCellRender="DayPilotMonth1_BeforeCellRender" 
