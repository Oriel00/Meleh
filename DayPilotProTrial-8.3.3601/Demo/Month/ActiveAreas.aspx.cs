...
public partial class Month_ActiveAreas : System.Web.UI.Page
{
    ...
    protected void DayPilotMonth1_BeforeEventRender(object sender, DayPilot.Web.Ui.Events.Month.BeforeEventRenderEventArgs e)
    {
        ...
        /*
        e.Areas.Add(new Area().Width(17).Bottom(9).Right(19).Top(3).CssClass("event_action_move").Move());
        e.Areas.Add(new Area().Width(17).Bottom(9).Right(2).Top(3).CssClass("event_action_bottomdrag").ResizeEnd());
         */
    }
